...
//--------------------------------
TypeDefVK70xNMCPara                  VK[MAX_TCP_CILENT_NUM];
TypeDefTCPServerPara                 VKTCPServer;

char                                 SD_DefaultFilePath[MAX_PATHNAME_LEN];
HANDLE                               RXLANMonitor_Handle, TCPMonitor_Handle;//线程
unsigned char                        TCPMonitor_ThreadRunningState, RXLANMonitor_ThreadRunningState;
