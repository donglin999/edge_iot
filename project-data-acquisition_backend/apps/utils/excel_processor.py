...
def process_excel_data(df):
    ...
    # 按protocol_type, source_ip, source_port, device_a_tag分组
    group_cols = ['protocol_type', 'source_ip', 'source_port', 'device_a_tag']
    ...
    for name, group in grouped:
        ...
        # 构建设备标识
        port_address = f"{name[0]}{name[1]} : {name[2]}{name[3]}"
